...
* IN THE SOFTWARE.
*/
CRunKcBoxA.FLAG_HYPERLINK = 0x00004000;
CRunKcBoxA.FLAG_CONTAINER = 0x00001000;
CRunKcBoxA.FLAG_CONTAINED = 0x00002000;
CRunKcBoxA.COLOR_NONE = 0xFFFF;
CRunKcBoxA.FLAG_BUTTON_PRESSED = 0x10000000;
CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED = 0x20000000;
CRunKcBoxA.FLAG_HIDEIMAGE = 0x01000000;
CRunKcBoxA.COLORFLAG_RGB= 0;
CRunKcBoxA.FLAG_CHECKED = 0;
CRunKcBoxA.COLOR_FLAGS = (CRunKcBoxA.COLORFLAG_RGB);
CRunKcBoxA.COLOR_BTNFACE = 15;
CRunKcBoxA.COLOR_3DLIGHT = 22;
CRunKcBoxA.FLAG_BUTTON = 0x00100000;
CRunKcBoxA.FLAG_CHECKBOX = 0x00200000;
CRunKcBoxA.FLAG_IMAGECHECKBOX = 0x00800000;
CRunKcBoxA.FLAG_DISABLED = 0x40000000;
CRunKcBoxA.FLAG_FORCECLIPPING = 0x02000000;
CRunKcBoxA.ALIGN_IMAGE_TOPLEFT = 0x00010000;
CRunKcBoxA.ALIGN_IMAGE_CENTER = 0x00020000;
CRunKcBoxA.ALIGN_IMAGE_PATTERN = 0x00040000;
CRunKcBoxA.ALIGN_TOP = 0x00000001;
CRunKcBoxA.ALIGN_VCENTER = 0x00000002;
CRunKcBoxA.ALIGN_BOTTOM = 0x00000004;
CRunKcBoxA.ALIGN_LEFT = 0x00000010;
CRunKcBoxA.ALIGN_HCENTER = 0x00000020;
CRunKcBoxA.ALIGN_RIGHT = 0x00000040;
CRunKcBoxA.ALIGN_MULTILINE = 0x00000100;
CRunKcBoxA.ALIGN_NOPREFIX = 0x00000200;
CRunKcBoxA.ALIGN_ENDELLIPSIS = 0x00000400;
CRunKcBoxA.ALIGN_PATHELLIPSIS = 0x00000800;
CRunKcBoxA.FLAG_SHOWBUTTONBORDER = 0x00400000;
CRunKcBoxA.bSysColorTab = false;
CRunKcBoxA.COLOR_GRADIENTINACTIVECAPTION = 25;//28;
CRunKcBoxA.sysColorTab=null;
CRunKcBoxA.DOCK_LEFT = 0x00000001;
CRunKcBoxA.DOCK_RIGHT = 0x00000002;
CRunKcBoxA.DOCK_TOP = 0x00000004;
CRunKcBoxA.DOCK_BOTTOM = 0x00000008;
CRunKcBoxA.DOCK_FLAGS = (CRunKcBoxA.DOCK_LEFT | CRunKcBoxA.DOCK_RIGHT | CRunKcBoxA.DOCK_TOP | CRunKcBoxA.DOCK_BOTTOM);
CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR=0;
CRunKcBoxA.TOOLTIP_TODISPLAY=0;
CRunKcBoxA.TOOLTIP_DISPLAYED=1;
CRunKcBoxA.TOOLTIP_HIDDEN=2;

CRunKcBoxA.CND_CLICKED = 0;
CRunKcBoxA.CND_ENABLED = 1;
CRunKcBoxA.CND_CHECKED = 2;
CRunKcBoxA.CND_LEFTCLICK = 3;
CRunKcBoxA.CND_RIGHTCLICK = 4;
CRunKcBoxA.CND_MOUSEOVER = 5;
CRunKcBoxA.CND_IMAGESHOWN = 6;
CRunKcBoxA.CND_DOCKED = 7;
	    
CRunKcBoxA.ACT_ACTION_SETDIM = 0;
CRunKcBoxA.ACT_ACTION_SETPOS = 1;	
CRunKcBoxA.ACT_ACTION_ENABLE = 2;
CRunKcBoxA.ACT_ACTION_DISABLE = 3;
CRunKcBoxA.ACT_ACTION_CHECK = 4;
CRunKcBoxA.ACT_ACTION_UNCHECK = 5;	
CRunKcBoxA.ACT_ACTION_SETCOLOR_NONE	= 6;
CRunKcBoxA.ACT_ACTION_SETCOLOR_3DDKSHADOW = 7;
CRunKcBoxA.ACT_ACTION_SETCOLOR_3DFACE = 8;
CRunKcBoxA.ACT_ACTION_SETCOLOR_3DHILIGHT = 9;
CRunKcBoxA.ACT_ACTION_SETCOLOR_3DLIGHT = 10;
CRunKcBoxA.ACT_ACTION_SETCOLOR_3DSHADOW = 11;
CRunKcBoxA.ACT_ACTION_SETCOLOR_ACTIVECAPTION = 12;
CRunKcBoxA.ACT_ACTION_SETCOLOR_APPWORKSPACE = 13; //mdi
CRunKcBoxA.ACT_ACTION_SETCOLOR_DESKTOP = 14;
CRunKcBoxA.ACT_ACTION_SETCOLOR_HIGHLIGHT = 15;
CRunKcBoxA.ACT_ACTION_SETCOLOR_INACTIVECAPTION = 16;
CRunKcBoxA.ACT_ACTION_SETCOLOR_INFOBK = 17;
CRunKcBoxA.ACT_ACTION_SETCOLOR_MENU = 18;
CRunKcBoxA.ACT_ACTION_SETCOLOR_SCROLLBAR = 19;
CRunKcBoxA.ACT_ACTION_SETCOLOR_WINDOW = 20;
CRunKcBoxA.ACT_ACTION_SETCOLOR_WINDOWFRAME = 21;	
CRunKcBoxA.ACT_ACTION_SETB1COLOR_NONE = 22;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DDKSHADOW	= 23;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DFACE = 24;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DHILIGHT = 25;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DLIGHT = 26;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DSHADOW = 27;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_ACTIVEBORDER = 28;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_INACTIVEBORDER = 29;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_WINDOWFRAME = 30;	
CRunKcBoxA.ACT_ACTION_SETB2COLOR_NONE = 31;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DDKSHADOW	= 32;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DFACE = 33;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DHILIGHT = 34;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DLIGHT = 35;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DSHADOW = 36;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_ACTIVEBORDER = 37;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_INACTIVEBORDER = 38;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_WINDOWFRAME = 39;	
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_NONE = 40;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_3DHILIGHT = 41;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_3DSHADOW = 42;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_BTNTEXT = 43;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_CAPTIONTEXT = 44;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_GRAYTEXT = 45;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_HIGHLIGHTTEXT = 46;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_INACTIVECAPTIONTEXT = 47;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_INFOTEXT = 48;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_MENUTEXT = 49;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_WINDOWTEXT = 50;	
CRunKcBoxA.ACT_ACTION_SETCOLOR_OTHER = 51;
CRunKcBoxA.ACT_ACTION_SETB1COLOR_OTHER = 52;
CRunKcBoxA.ACT_ACTION_SETB2COLOR_OTHER = 53;
CRunKcBoxA.ACT_ACTION_TEXTCOLOR_OTHER = 54;	
CRunKcBoxA.ACT_ACTION_SETTEXT = 55;
CRunKcBoxA.ACT_ACTION_SETTOOLTIPTEXT = 56;	
CRunKcBoxA.ACT_ACTION_UNDOCK = 57;
CRunKcBoxA.ACT_ACTION_DOCK_LEFT = 58;
CRunKcBoxA.ACT_ACTION_DOCK_RIGHT = 59;
CRunKcBoxA.ACT_ACTION_DOCK_TOP = 60;
CRunKcBoxA.ACT_ACTION_DOCK_BOTTOM = 61;	
CRunKcBoxA.ACT_ACTION_SHOWIMAGE = 62;
CRunKcBoxA.ACT_ACTION_HIDEIMAGE = 63;	
CRunKcBoxA.ACT_ACTION_RESETCLICKSTATE = 64;	
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_NONE = 65;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_3DHILIGHT = 66;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_3DSHADOW = 67;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_BTNTEXT = 68;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_CAPTIONTEXT = 69;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_GRAYTEXT = 70;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_HIGHLIGHTTEXT = 71;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_INACTIVECAPTIONTEXT = 72;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_INFOTEXT = 73;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_MENUTEXT = 74;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_WINDOWTEXT = 75;
CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_OTHER = 76;	
CRunKcBoxA.ACT_ACTION_SETCMDID = 77;

CRunKcBoxA.EXP_COLOR_BACKGROUND = 0;
CRunKcBoxA.EXP_COLOR_BORDER1 = 1;
CRunKcBoxA.EXP_COLOR_BORDER2 = 2;
CRunKcBoxA.EXP_COLOR_TEXT = 3;	
CRunKcBoxA.EXP_COLOR_3DDKSHADOW = 4;
CRunKcBoxA.EXP_COLOR_3DFACE = 5;
CRunKcBoxA.EXP_COLOR_3DHILIGHT = 6;
CRunKcBoxA.EXP_COLOR_3DLIGHT = 7;
CRunKcBoxA.EXP_COLOR_3DSHADOW = 8;
CRunKcBoxA.EXP_COLOR_ACTIVEBORDER = 9;
CRunKcBoxA.EXP_COLOR_ACTIVECAPTION = 10;
CRunKcBoxA.EXP_COLOR_APPWORKSPACE = 11;
CRunKcBoxA.EXP_COLOR_DESKTOP = 12;
CRunKcBoxA.EXP_COLOR_BTNTEXT = 13;
CRunKcBoxA.EXP_COLOR_CAPTIONTEXT = 14;
CRunKcBoxA.EXP_COLOR_GRAYTEXT = 15;
CRunKcBoxA.EXP_COLOR_HIGHLIGHT = 16;
CRunKcBoxA.EXP_COLOR_HIGHLIGHTTEXT = 17;
CRunKcBoxA.EXP_COLOR_INACTIVEBORDER = 18;
CRunKcBoxA.EXP_COLOR_INACTIVECAPTION = 19;
CRunKcBoxA.EXP_COLOR_INACTIVECAPTIONTEXT = 20;
CRunKcBoxA.EXP_COLOR_INFOBK = 21;
CRunKcBoxA.EXP_COLOR_INFOTEXT = 22;
CRunKcBoxA.EXP_COLOR_MENU = 23;
CRunKcBoxA.EXP_COLOR_MENUTEXT = 24;
CRunKcBoxA.EXP_COLOR_SCROLLBAR = 25;
CRunKcBoxA.EXP_COLOR_WINDOW = 26;
CRunKcBoxA.EXP_COLOR_WINDOWFRAME = 27;
CRunKcBoxA.EXP_COLOR_WINDOWTEXT = 28;
CRunKcBoxA.EXP_GETTEXT = 29;
CRunKcBoxA.EXP_GETTOOLTIPTEXT = 30;
CRunKcBoxA.EXP_GETWIDTH = 31;
CRunKcBoxA.EXP_GETHEIGHT = 32;
CRunKcBoxA.EXP_COLOR_HYPERLINK = 33;
CRunKcBoxA.EXP_GETX = 34;
CRunKcBoxA.EXP_GETY = 35;
CRunKcBoxA.EXP_SYSTORGB = 36;

this.KcBoxA = CRunKcBoxA;
...
CRunKcBoxA.prototype=CServices.extend(new CRunExtension(),
{
    ...
    createRunObject:function(file, cob, version)
    {
		...
		// Setup
		CRunKcBoxA.COLORFLAG_RGB=1<<31;
		CRunKcBoxA.FLAG_CHECKED=1<<31;
		CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR=1<<31;
        ...
        if (textLf.lfFaceName != null)
        {
            ...
            {
            	this.wUnderlinedFont.copy(textLf);
                this.wUnderlinedFont.lfUnderline = 1;
            }
        }
        ...
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_CONTAINER) != 0)
        {
            this.rNumInContList = pData.AddContainer(this);
        }

        this.rContNum = -1;
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_CONTAINED) != 0)
        {
        ...
        if ((this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON | CRunKcBoxA.FLAG_HYPERLINK)) != 0)
        {
...
//            this.textSurface.recycle();
    ...
    mouseClicked:function()
    {
        ...
        if (pData != null)
        {
            ...
            {
                if (this.rNumInObjList == pData.GetObjectFromList(this.rh.rh2MouseX-this.rh.rhWindowX, this.rh.rh2MouseY-this.rh.rhWindowY))
                {
                    this.rClickCount = this.ho.getEventCount();
                    this.ho.pushEvent(CRunKcBoxA.CND_CLICKED, this.ho.getEventParam());
                }
            }
        }
    },
    ...
    mousePressed:function()
    {
        ...
        if (pData != null)
        {
            if ((this.rData_dwFlags & CRunKcBoxA.FLAG_DISABLED) == 0)
            {
                if (this.rNumInObjList == pData.GetObjectFromList(this.rh.rh2MouseX-this.rh.rhWindowX, this.rh.rh2MouseY-this.rh.rhWindowY))
                {
                    if ((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON) != 0)//is a button
                    {
                        this.rData_dwFlags |= CRunKcBoxA.FLAG_BUTTON_PRESSED;
                        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_CHECKBOX) != 0)//is a checkbox
                        {
                            if ((this.rData_dwFlags & CRunKcBoxA.FLAG_CHECKED) != 0) //is checked
                            {
                                this.rData_dwFlags &= ~CRunKcBoxA.FLAG_CHECKED;
                            }
                            else
                            {
                                this.rData_dwFlags |= CRunKcBoxA.FLAG_CHECKED;
                    ...
                    if ((this.rData_dwFlags & CRunKcBoxA.FLAG_HYPERLINK) != 0) //if hyperlink
                    {
                        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED) == 0)
                        {
                            this.rData_dwFlags |= CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED;
                        }
                    }
                    this.rLeftClickCount = this.ho.getEventCount();
                    this.ho.pushEvent(CRunKcBoxA.CND_LEFTCLICK, this.ho.getEventParam());
                    this.ho.redraw();
                }
            }
        }
    ...
    {
        var redraw = false;
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON_PRESSED) != 0)
        {
            this.rData_dwFlags &= ~CRunKcBoxA.FLAG_BUTTON_PRESSED;
            redraw = true;
        }
    ...
    handleRunObject:function()
    {
        ...
        var kMouse=rhPtr.rhApp.keyBuffer[CRunApp.VK_LBUTTON];
        ...
        if (pData != null)
        {
            ...
            if (bActive == true)
            {
                if (((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON) != 0) || ((this.rData_dwFlags & CRunKcBoxA.FLAG_HYPERLINK) != 0)) //15th april 09 change
                {
                    if ((this.rData_dwFlags & CRunKcBoxA.FLAG_DISABLED) == 0)
                    {
                        if (this.rNumInObjList == pData.GetObjectFromList(this.rh.rh2MouseX, this.rh.rh2MouseY))
                        {
                            if ((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED) == 0)
                            {
                                this.rData_dwFlags |= CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED;
        ...
        // Docking
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_FLAGS) != 0 && (this.rData_dwFlags & CRunKcBoxA.FLAG_CONTAINED) == 0)
        {
            var windowWidth = rhPtr.rhApp.gaCxWin;
            var windowHeight = rhPtr.rhApp.gaCyWin;
            var x = 0;
            var y = 0;
            var w = rhPtr.rhApp.gaCxWin;
            var h = rhPtr.rhApp.gaCyWin;
            // Dock
            if ((this.dwRtFlags & CRunKcBoxA.DOCK_LEFT) != 0)
            {
                if (windowWidth > w)
                {
                    newX = this.rh.rhFrame.leX + Math.abs(x) - (windowWidth - w) / 2;
                }
                else
                {
                    newX = this.rh.rhFrame.leX + Math.abs(x);
                }
            }
            if ((this.dwRtFlags & CRunKcBoxA.DOCK_RIGHT) != 0)
            {
                if (windowWidth > w)
                {
                    newX = this.rh.rhFrame.leX + Math.abs(x) + w - this.ho.getWidth() - (windowWidth - w) / 2;
                }
                else
                {
                    newX = this.rh.rhFrame.leX + Math.abs(x) + w - this.ho.getWidth();
                }
            }
            if ((this.dwRtFlags & CRunKcBoxA.DOCK_TOP) != 0)
            {
                if (windowHeight > h)
                {
                    newY = this.rh.rhFrame.leY + Math.abs(y) - (windowHeight - h) / 2;
                }
                else
                {
                    newY = this.rh.rhFrame.leY + Math.abs(y);
                }
            }
            if ((this.dwRtFlags & CRunKcBoxA.DOCK_BOTTOM) != 0)
            {
                if (windowHeight > h)
                {
                    newY = this.rh.rhFrame.leY + Math.abs(y) + h - this.ho.getHeight() - (windowHeight - h) / 2;
                }
                else
                {
                    newY = this.rh.rhFrame.leY - Math.abs(y) + h - this.ho.getHeight(); //requires - here for some reason.
                }
            }
        }
    ...
    displayRunObject:function(context, xDraw, yDraw)
    {
        ...
        var rc = new CRect();
        rc.left = this.ho.hoX+xDraw+this.ho.pLayer.x;
        rc.top = this.ho.hoY+yDraw+this.ho.pLayer.y;
        rc.right = rc.left+this.ho.hoImgWidth;
        rc.bottom = rc.top+this.ho.hoImgHeight;

		var hFn=this.wFont;
        if ((this.pText.length!=0) && (this.rData_textColor!=CRunKcBoxA.COLOR_NONE))
        {
            if (((this.rData_dwFlags & CRunKcBoxA.FLAG_HYPERLINK) != 0) && (this.wUnderlinedFont != null))
            {
    ...
    {
        sysColorTab = new Array(CRunKcBoxA.COLOR_GRADIENTINACTIVECAPTION);
    ...
    myGetSysColor:function(colorIndex)
    {
        ...
        // Get color
        if (colorIndex < CRunKcBoxA.COLOR_GRADIENTINACTIVECAPTION)
        {
    ...
    DisplayObject:function(context, idAppApp, rc, pText, hFnt)
    {
        ...
        // Background
        var color;
        if (this.rData_fillColor != CRunKcBoxA.COLOR_NONE)
        {
            var clr = this.rData_fillColor;
            if ((clr & CRunKcBoxA.COLORFLAG_RGB) != 0)
            {
                color = clr & ~CRunKcBoxA.COLOR_FLAGS;
                color = fromC(color);
            }
            else
            {
                if (((this.rData_dwFlags & CRunKcBoxA.FLAG_CHECKED) != 0) && (clr == CRunKcBoxA.COLOR_BTNFACE))
                {
                    clr = CRunKcBoxA.COLOR_3DLIGHT;
                }
        ...
        {
        	if (((this.rData_dwFlags & CRunKcBoxA.FLAG_HIDEIMAGE) == 0))
	        {
	            var bDisplayImage = true;
	            if ((this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON | CRunKcBoxA.FLAG_CHECKBOX | CRunKcBoxA.FLAG_IMAGECHECKBOX)) == (CRunKcBoxA.FLAG_BUTTON | CRunKcBoxA.FLAG_CHECKBOX | CRunKcBoxA.FLAG_IMAGECHECKBOX))
	            {
	                if ((this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON_PRESSED | CRunKcBoxA.FLAG_CHECKED)) == 0)
	                {
	                    bDisplayImage = false;
	                }
	            }
	            if (bDisplayImage == true)
	            {
	                ...
	                this.rData_dwFlags &= ~CRunKcBoxA.FLAG_FORCECLIPPING;
        ...
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_BUTTON) != 0)
        {
            if ((this.rData_dwFlags & CRunKcBoxA.FLAG_SHOWBUTTONBORDER) == 0)
            {
                bDisplayBorder = ((this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON_HIGHLIGHTED | CRunKcBoxA.FLAG_BUTTON_PRESSED | CRunKcBoxA.FLAG_CHECKED)) != 0);
            }
            if ((this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON_PRESSED | CRunKcBoxA.FLAG_CHECKED)) != 0 &&
                    (this.rData_dwFlags & (CRunKcBoxA.FLAG_BUTTON | CRunKcBoxA.FLAG_CHECKBOX | CRunKcBoxA.FLAG_IMAGECHECKBOX)) != (CRunKcBoxA.FLAG_BUTTON | CRunKcBoxA.FLAG_CHECKBOX | CRunKcBoxA.FLAG_IMAGECHECKBOX))
            {
                color1 = this.rData_borderColor2;
                color2 = this.rData_borderColor1;
            }
        }
    ...
    {
        this.rData_textColor = CServices.swapRGB(rgb)|CRunKcBoxA.COLORFLAG_RGB;
        this.ho.redraw();
    },
    ...
    condition:function(num, cnd)
    {
        switch (num)
        {
            case CRunKcBoxA.CND_CLICKED:
                return this.IsClicked();
            case CRunKcBoxA.CND_ENABLED:
                return this.IsEnabled();
            case CRunKcBoxA.CND_CHECKED:
                return this.IsChecked();
            case CRunKcBoxA.CND_LEFTCLICK:
                return this.LeftClick();
            case CRunKcBoxA.CND_RIGHTCLICK:
                return this.RightClick();
            case CRunKcBoxA.CND_MOUSEOVER:
                return this.MouseOver();
            case CRunKcBoxA.CND_IMAGESHOWN:
                return this.IsImageShown();
            case CRunKcBoxA.CND_DOCKED:
    ...
    IsClicked:function()
    {
        ...
        if (rhPtr.rh4EventCount == this.rClickCount)
        {
            return true;
        }
        return false;
    ...
    IsEnabled:function()
    {
        return ((this.rData_dwFlags & CRunKcBoxA.FLAG_DISABLED) == 0);
    },

    IsChecked:function()
    {
        return ((this.rData_dwFlags & CRunKcBoxA.FLAG_CHECKED) != 0);
    },
    ...
    LeftClick:function()
    {
        ...
        if (rhPtr.rh4EventCount == this.rLeftClickCount)
        {
            return true;
        }
        return false;
    ...
    RightClick:function()
    {
        ...
        if (rhPtr.rh4EventCount == this.rRightClickCount)
        {
            return true;
        }
        return false;
    ...
    {
        return ((this.rData_dwFlags & CRunKcBoxA.FLAG_HIDEIMAGE) == 0);
    },

    IsDocked:function()
    {
        return ((this.dwRtFlags & CRunKcBoxA.DOCK_FLAGS) != 0);
    },
    ...
    action:function(num, act)
    {
        switch (num)
        {
            case CRunKcBoxA.ACT_ACTION_SETDIM:
                this.SetDimensions(act.getParamExpression(this.rh, 0), act.getParamExpression(this.rh, 1));
                break;
            case CRunKcBoxA.ACT_ACTION_SETPOS:
                this.SetPosition(act.getParamExpression(this.rh, 0), act.getParamExpression(this.rh, 1));
                break;
            case CRunKcBoxA.ACT_ACTION_ENABLE:
                this.Enable();
                break;
            case CRunKcBoxA.ACT_ACTION_DISABLE:
                this.Disable();
                break;
            case CRunKcBoxA.ACT_ACTION_CHECK:
                this.Check();
                break;
            case CRunKcBoxA.ACT_ACTION_UNCHECK:
                this.Uncheck();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_NONE:
                this.SetFillColor_None();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_3DDKSHADOW:
                this.SetFillColor_3DDKSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_3DFACE:
                this.SetFillColor_3DFACE();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_3DHILIGHT:
                this.SetFillColor_3DHIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_3DLIGHT:
                this.SetFillColor_3DLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_3DSHADOW:
                this.SetFillColor_3DSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_ACTIVECAPTION:
                this.SetFillColor_ACTIVECAPTION();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_APPWORKSPACE:
                this.SetFillColor_APPWORKSPACE();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_DESKTOP:
                this.SetFillColor_DESKTOP();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_HIGHLIGHT:
                this.SetFillColor_HIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_INACTIVECAPTION:
                this.SetFillColor_INACTIVECAPTION();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_INFOBK:
                this.SetFillColor_INFOBK();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_MENU:
                this.SetFillColor_MENU();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_SCROLLBAR:
                this.SetFillColor_SCROLLBAR();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_WINDOW:
                this.SetFillColor_WINDOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_WINDOWFRAME:
                this.SetFillColor_WINDOWFRAME();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCOLOR_OTHER:
                this.SetFillColor_Other(act.getParamExpression(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_NONE:
                this.SetB1Color_None();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DDKSHADOW:
                this.SetB1Color_3DDKSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DFACE:
                this.SetB1Color_3DFACE();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DHILIGHT:
                this.SetB1Color_3DHIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_3DSHADOW:
                this.SetB1Color_3DSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_ACTIVEBORDER:
                this.SetB1Color_ACTIVEBORDER();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_INACTIVEBORDER:
                this.SetB1Color_INACTIVEBORDER();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_WINDOWFRAME:
                this.SetB1Color_WINDOWFRAME();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB1COLOR_OTHER:
                this.SetB1Color_Other(act.getParamExpression(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_NONE:
                this.SetB2Color_None();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DDKSHADOW:
                this.SetB2Color_3DDKSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DFACE:
                this.SetB2Color_3DFACE();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DHILIGHT:
                this.SetB2Color_3DHIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DLIGHT:
                this.SetB2Color_3DLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_3DSHADOW:
                this.SetB2Color_3DSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_ACTIVEBORDER:
                this.SetB2Color_ACTIVEBORDER();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_INACTIVEBORDER:
                this.SetB2Color_INACTIVEBORDER();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_WINDOWFRAME:
                this.SetB2Color_WINDOWFRAME();
                break;
            case CRunKcBoxA.ACT_ACTION_SETB2COLOR_OTHER:
                this.SetB2Color_Other(act.getParamExpression(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_NONE:
                this.SetTxtColor_None();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_3DHILIGHT:
                this.SetTxtColor_3DHIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_3DSHADOW:
                this.SetTxtColor_3DSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_BTNTEXT:
                this.SetTxtColor_BTNTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_CAPTIONTEXT:
                this.SetTxtColor_CAPTIONTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_GRAYTEXT:
                this.SetTxtColor_GRAYTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_HIGHLIGHTTEXT:
                this.SetTxtColor_HIGHLIGHTTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_INACTIVECAPTIONTEXT:
                this.SetTxtColor_INACTIVECAPTIONTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_INFOTEXT:
                this.SetTxtColor_INFOTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_MENUTEXT:
                this.SetTxtColor_MENUTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_WINDOWTEXT:
                this.SetTxtColor_WINDOWTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_TEXTCOLOR_OTHER:
                this.SetTxtColor_Other(act.getParamExpression(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_NONE:
                this.SetHyperlinkColor_None();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_3DHILIGHT:
                this.SetHyperlinkColor_3DHIGHLIGHT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_3DSHADOW:
                this.SetHyperlinkColor_3DSHADOW();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_BTNTEXT:
                this.SetHyperlinkColor_BTNTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_CAPTIONTEXT:
                this.SetHyperlinkColor_CAPTIONTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_GRAYTEXT:
                this.SetHyperlinkColor_GRAYTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_HIGHLIGHTTEXT:
                this.SetHyperlinkColor_HIGHLIGHTTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_INACTIVECAPTIONTEXT:
                this.SetHyperlinkColor_INACTIVECAPTIONTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_INFOTEXT:
                this.SetHyperlinkColor_INFOTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_MENUTEXT:
                this.SetHyperlinkColor_MENUTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_WINDOWTEXT:
                this.SetHyperlinkColor_WINDOWTEXT();
                break;
            case CRunKcBoxA.ACT_ACTION_HYPERLINKCOLOR_OTHER:
                this.SetHyperlinkColor_Other(act.getParamExpression(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_SETTEXT:
                this.SetText(act.getParamExpString(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_SETTOOLTIPTEXT:
                this.SetToolTipText(act.getParamExpString(this.rh, 0));
                break;
            case CRunKcBoxA.ACT_ACTION_UNDOCK:
                this.Undock();
                break;
            case CRunKcBoxA.ACT_ACTION_DOCK_LEFT:
                this.DockLeft();
                break;
            case CRunKcBoxA.ACT_ACTION_DOCK_RIGHT:
                this.DockRight();
                break;
            case CRunKcBoxA.ACT_ACTION_DOCK_TOP:
                this.DockTop();
                break;
            case CRunKcBoxA.ACT_ACTION_DOCK_BOTTOM:
                this.DockBottom();
                break;
            case CRunKcBoxA.ACT_ACTION_SHOWIMAGE:
                this.ShowImage();
                break;
            case CRunKcBoxA.ACT_ACTION_HIDEIMAGE:
                this.HideImage();
                break;
            case CRunKcBoxA.ACT_ACTION_RESETCLICKSTATE:
                this.ResetClickState();
                break;
            case CRunKcBoxA.ACT_ACTION_SETCMDID: //non operational
                this.AttachMenuCmd();
                break;
        }
    },
    ...
    Enable:function()
    {
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_DISABLED) != 0)
        {
            this.rData_dwFlags &= ~CRunKcBoxA.FLAG_DISABLED;
            this.ho.redraw();
        }
    },
    ...
    Check:function()
    {
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_CHECKED) == 0)
        {
            this.rData_dwFlags |= CRunKcBoxA.FLAG_CHECKED;
            this.ho.redraw();
        }
    ...
    SetFillColor_None:function()
    {
        if (this.rData_fillColor != CRunKcBoxA.COLOR_NONE)
        {
            this.rData_fillColor = CRunKcBoxA.COLOR_NONE;
            this.ho.redraw();
        }
    },
    ...
    {
        if ((c & CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR) != 0)
        {
            c &= 0xFFFF;
        }
        else
    ...
    {
        if (this.rData_borderColor1 != CRunKcBoxA.COLOR_NONE)
        {
            this.rData_borderColor1 = CRunKcBoxA.COLOR_NONE;
            this.ho.redraw();
        }
    },
    ...
    {
        if (this.rData_borderColor2 != CRunKcBoxA.COLOR_NONE)
        {
            this.rData_borderColor2 = CRunKcBoxA.COLOR_NONE;
            this.ho.redraw();
        }
    },
    ...
    {
        if (this.rData_textColor != CRunKcBoxA.COLOR_NONE)
        {
            this.rData_textColor = CRunKcBoxA.COLOR_NONE;
	        this.displayText=true;
            this.ho.redraw();
        }
    },
    ...
    {
        if (this.rData1_dwUnderlinedColor != CRunKcBoxA.COLOR_NONE)
        {
            this.rData1_dwUnderlinedColor = CRunKcBoxA.COLOR_NONE;
	        this.displayText=true;
            this.ho.redraw();
        }
    },
    ...
    Undock:function()
    {
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_FLAGS) != 0)
        {
            this.dwRtFlags &= ~CRunKcBoxA.DOCK_FLAGS;
        }
    },
    ...
    DockLeft:function()
    {
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_LEFT) == 0)
        {
            this.dwRtFlags |= CRunKcBoxA.DOCK_LEFT;
            this.ho.reHandle();
        }
    },
    ...
    DockRight:function()
    {
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_RIGHT) == 0)
        {
            this.dwRtFlags |= CRunKcBoxA.DOCK_RIGHT;
            this.ho.reHandle();
        }
    },
    ...
    DockTop:function()
    {
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_TOP) == 0)
        {
            this.dwRtFlags |= CRunKcBoxA.DOCK_TOP;
            this.ho.reHandle();
        }
    },
    ...
    DockBottom:function()
    {
        if ((this.dwRtFlags & CRunKcBoxA.DOCK_BOTTOM) == 0)
        {
            this.dwRtFlags |= CRunKcBoxA.DOCK_BOTTOM;
            this.ho.reHandle();
        }
    },
    ...
    ShowImage:function()
    {
        if ((this.rData_dwFlags & CRunKcBoxA.FLAG_HIDEIMAGE) != 0)
        {
            this.rData_dwFlags &= ~CRunKcBoxA.FLAG_HIDEIMAGE;
            this.ho.redraw();
        }
    },
    ...
    expression:function(num)
    {
        switch (num)
        {
            case CRunKcBoxA.EXP_COLOR_BACKGROUND:
                return this.ExpColorBackground();
            case CRunKcBoxA.EXP_COLOR_BORDER1:
                return this.ExpColorBorder1();
            case CRunKcBoxA.EXP_COLOR_BORDER2:
                return this.ExpColorBorder2();
            case CRunKcBoxA.EXP_COLOR_TEXT:
                return this.ExpColorText();
            case CRunKcBoxA.EXP_COLOR_HYPERLINK:
                return this.ExpColorHyperlink();
            case CRunKcBoxA.EXP_COLOR_3DDKSHADOW:
                return this.ExpColor_3DDKSHADOW();
            case CRunKcBoxA.EXP_COLOR_3DFACE:
                return this.ExpColor_3DFACE();
            case CRunKcBoxA.EXP_COLOR_3DHILIGHT:
                return this.ExpColor_3DHILIGHT();
            case CRunKcBoxA.EXP_COLOR_3DLIGHT:
                return this.ExpColor_3DLIGHT();
            case CRunKcBoxA.EXP_COLOR_3DSHADOW:
                return this.ExpColor_3DSHADOW();
            case CRunKcBoxA.EXP_COLOR_ACTIVEBORDER:
                return this.ExpColor_ACTIVEBORDER();
            case CRunKcBoxA.EXP_COLOR_ACTIVECAPTION:
                return this.ExpColor_ACTIVECAPTION();
            case CRunKcBoxA.EXP_COLOR_APPWORKSPACE:
                return this.ExpColor_APPWORKSPACE();
            case CRunKcBoxA.EXP_COLOR_DESKTOP:
                return this.ExpColor_DESKTOP();
            case CRunKcBoxA.EXP_COLOR_BTNTEXT:
                return this.ExpColor_BTNTEXT();
            case CRunKcBoxA.EXP_COLOR_CAPTIONTEXT:
                return this.ExpColor_CAPTIONTEXT();
            case CRunKcBoxA.EXP_COLOR_GRAYTEXT:
                return this.ExpColor_GRAYTEXT();
            case CRunKcBoxA.EXP_COLOR_HIGHLIGHT:
                return this.ExpColor_HIGHLIGHT();
            case CRunKcBoxA.EXP_COLOR_HIGHLIGHTTEXT:
                return this.ExpColor_HIGHLIGHTTEXT();
            case CRunKcBoxA.EXP_COLOR_INACTIVEBORDER:
                return this.ExpColor_INACTIVEBORDER();
            case CRunKcBoxA.EXP_COLOR_INACTIVECAPTION:
                return this.ExpColor_INACTIVECAPTION();
            case CRunKcBoxA.EXP_COLOR_INACTIVECAPTIONTEXT:
                return this.ExpColor_INACTIVECAPTIONTEXT();
            case CRunKcBoxA.EXP_COLOR_INFOBK:
                return this.ExpColor_INFOBK();
            case CRunKcBoxA.EXP_COLOR_INFOTEXT:
                return this.ExpColor_INFOTEXT();
            case CRunKcBoxA.EXP_COLOR_MENU:
                return this.ExpColor_MENU();
            case CRunKcBoxA.EXP_COLOR_MENUTEXT:
                return this.ExpColor_MENUTEXT();
            case CRunKcBoxA.EXP_COLOR_SCROLLBAR:
                return this.ExpColor_SCROLLBAR();
            case CRunKcBoxA.EXP_COLOR_WINDOW:
                return this.ExpColor_WINDOW();
            case CRunKcBoxA.EXP_COLOR_WINDOWFRAME:
                return this.ExpColor_WINDOWFRAME();
            case CRunKcBoxA.EXP_COLOR_WINDOWTEXT:
                return this.ExpColor_WINDOWTEXT();
            case CRunKcBoxA.EXP_GETTEXT:
                return this.ExpGetText();
            case CRunKcBoxA.EXP_GETTOOLTIPTEXT.pText:
                return this.ExpGetToolTipText();
            case CRunKcBoxA.EXP_GETWIDTH:
                return this.ExpGetWidth();
            case CRunKcBoxA.EXP_GETHEIGHT:
                return this.ExpGetHeight();
            case CRunKcBoxA.EXP_GETX:
                return this.ExpGetX();
            case CRunKcBoxA.EXP_GETY:
                return this.ExpGetY();
            case CRunKcBoxA.EXP_SYSTORGB:
    ...
    ExpColorBackground:function()
    {
        ...
        {
            clr |= CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR;
        }
        return clr;
    },
    ...
    {
        return (21 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_3DFACE:function()
    {
        return (15 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_3DHILIGHT:function()
    {
        (20 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_3DLIGHT:function()
    {
        return (22 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_3DSHADOW:function()
    {
        return (16 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_ACTIVEBORDER:function()
    {
        return (10 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_ACTIVECAPTION:function()
    {
        return (2 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_APPWORKSPACE:function()
    {
        return (12 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_DESKTOP:function()
    {
        return (1 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_BTNTEXT:function()
    {
        return (18 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_CAPTIONTEXT:function()
    {
        return (9 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_GRAYTEXT:function()
    {
        return (17 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_HIGHLIGHT:function()
    {
        return (13 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_HIGHLIGHTTEXT:function()
    {
        return (14 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_INACTIVEBORDER:function()
    {
        return (11 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_INACTIVECAPTION:function()
    {
        return (3 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_INACTIVECAPTIONTEXT:function()
    {
        return (19 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_INFOBK:function()
    {
        return (24 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_INFOTEXT:function()
    {
        return (23 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_MENU:function()
    {
        return (4 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_MENUTEXT:function()
    {
        return (7 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_SCROLLBAR:function()
    {
        return (0 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_WINDOW:function()
    {
        return (5 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_WINDOWFRAME:function()
    {
        return (6 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },

    ExpColor_WINDOWTEXT:function()
    {
        return (8 | CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR);
    },
    ...
    ExpSysToRGB:function()
    {
        ...
        if ((paramColor & CRunKcBoxA.PARAMFLAG_SYSTEMCOLOR) != 0)
        {
...
CRunKcBoxAFrameData.TYPE_OBJECT=0;
CRunKcBoxAFrameData.TYPE_CONTAINER=1;
CRunKcBoxAFrameData.TYPE_BUTTON=2;
CRunKcBoxAFrameData.FLAG_CONTAINED= 0x00002000;

function CRunKcBoxAFrameData()
{
    this.pObjects=null;
    this.pContainers=null;	    
    this.pButtons=null;    
    this.gClickedButton=0;
    this.gHighlightedButton=0;
}
CRunKcBoxAFrameData.prototype=
{
    IsEmpty:function()
    {
    	var i;
    ...
    {
    	var i;
        if (t == CRunKcBoxAFrameData.TYPE_OBJECT)
        {
           // 1st allocation
            if (this.pObjects == null)
            {
        ...
        if (t == CRunKcBoxAFrameData.TYPE_CONTAINER)
        {
            if (this.pContainers == null)
            {
        ...
        if (t == CRunKcBoxAFrameData.TYPE_BUTTON)
        {
            if (this.pButtons == null)
            {
                this.pButtons = new CArrayList();
                this.pButtons.add(reObject);
                return 0;
            }
            // Search for free place
            for (i=0; i < this.pButtons.size(); i++)
            {
                if (this.pButtons.get(i) == null )
                {
                    this.pButtons.set(i, reObject);
                    return i;
                }
            }
            // Reallocation
    ...
    RemoveObjAddr:function(t, reObject)
    {
        ...
        if (t == CRunKcBoxAFrameData.TYPE_BUTTON)
        {
            if (this.pButtons != null)
            {
                i = this.pButtons.indexOf(reObject);
                if (i != -1)
                {
                    this.pButtons.set(i, null);
                } 
            }
        }      
    },
    ...
    {
        return this.AddObjAddr(CRunKcBoxAFrameData.TYPE_CONTAINER, re);
    },
    AddObject:function(re)
    {
        return this.AddObjAddr(CRunKcBoxAFrameData.TYPE_OBJECT, re);
    },
    AddButton:function(re)
    {
        return this.AddObjAddr(CRunKcBoxAFrameData.TYPE_BUTTON, re);
    },
    RemoveContainer:function(re)
    {
        this.RemoveObjAddr(CRunKcBoxAFrameData.TYPE_CONTAINER, re);
    },
    RemoveObjectFromList:function(re)
    {
        this.RemoveObjAddr(CRunKcBoxAFrameData.TYPE_OBJECT, re);
    },
    RemoveButton:function(re)
    {
        this.RemoveObjAddr(TYPE_BUTTON, re);
    },
		...
		if (this.pObjects != null)
        {
            for (i=0; i < this.pObjects.size(); i++)
            {
                if (this.pObjects.get(i) != null)
                {
                    var reThisOne = this.pObjects.get(i);
                    // Contained ? must update coordinates
                    if ((reThisOne.rData_dwFlags & CRunKcBoxA.FLAG_CONTAINED) != 0)
                    {
                        // Not yet a container? search Medor, search!
